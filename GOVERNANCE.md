...
`cloud-itonami-iso3166-lie` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Liechtenstein-licensed counsel or a registered agent for whatever licensed
representation the law of Liechtenstein requires for public-procurement
filings (see `docs/business-model.md` for the confirmed Öffentliches
Auftragswesen / Handelsregister / fiscal-representative regime this
actor is scoped to).
